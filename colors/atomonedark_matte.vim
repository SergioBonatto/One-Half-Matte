...
let g:colors_name = "atomonedark_matte"
...
let s:hue_4     = "#8eae7a"
let s:hue_5     = "#c97a80"
let s:hue_5_2   = "#c97a80"
let s:hue_6     = "#c9ad79"
let s:hue_6_2   = "#c9ad79"

let s:syntax_bg     = "#2f3238"
let s:syntax_gutter = "#8d949c"
let s:syntax_guide  = "#44484f"
let s:syntax_accent = "#78a4c4"
...
let s:fg        = {"gui": s:mono_1,    "cterm": "188"}
let s:bg        = {"gui": s:syntax_bg, "cterm": "236"}
let s:comment   = {"gui": s:mono_3,    "cterm": "241"}
let s:keyword   = {"gui": s:hue_3,     "cterm": "176"}
let s:string    = {"gui": s:hue_4,     "cterm": "114"}
let s:function  = {"gui": s:hue_1,     "cterm": "75"}
let s:variable  = {"gui": s:hue_5,     "cterm": "168"}
let s:number    = {"gui": s:hue_6,     "cterm": "180"}
let s:visual    = {"gui": "#4a5058",   "cterm": "239"}
let s:gutter    = {"gui": s:syntax_gutter, "cterm": "247"}
...
call s:h("CursorLine",    {"bg": {"gui": "#383c43", "cterm": "237"}})
call s:h("CursorLineNr",  {"fg": s:fg,      "gui": "bold", "cterm": "bold"})
call s:h("CursorColumn",  {"bg": {"gui": "#383c43", "cterm": "237"}})
call s:h("ColorColumn",   {"bg": {"gui": "#383c43", "cterm": "237"}})
call s:h("LineNr",        {"fg": s:gutter})
call s:h("VertSplit",     {"fg": {"gui": "#383c43", "cterm": "237"}, "bg": s:bg})
call s:h("Folded",        {"fg": s:comment, "bg": {"gui": "#383c43", "cterm": "237"}, "gui": "italic"})
...
" ===================================================================
" LSP SUPPORT - One Half Matte Dark Theme
" ===================================================================
